        ...
        for mu in mu1:
            ...
            for chain in chains:
                for i in range(0, 700):
                    ...
                    file_path = f"../../data/wilson_loop_spatial/{monopole}/qc2dstag/{conf_size}/mu{mu}/{chain}/wilson_loop_spatial_{i:04}"
            ...
            if len(data) == 0:
                ...
                path_output = f"../../result/potential_spatial/{monopole}/qc2dstag/{conf_size}"
                ...
                df1.to_csv(
                    f"{path_output}/potential_spatial_mu={mu}.csv", index=False)
